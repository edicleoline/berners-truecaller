...
buildscript {
    ...
    repositories {
        ...
        maven { url = uri("../truecaller-prebuilts/m2repository") }
    }
    dependencies {
...
allprojects {
    repositories {
        ...
        maven { url = uri("${project.rootDir}/../truecaller-prebuilts/repository") }
        // - Other dependencies
        maven { url = uri("${project.rootDir}/../truecaller-prebuilts/m2repository") }
